...
````
**ROTARY_STEP_VALUE** defines the increase/decrease for a detected rotary moves. 
When the time between 2 events is below 60 ms the value of ROTARY_STEP_VALUE is doubled and if the time is below 30 ms the effective step value is ROTARY_STEP_VALUE*4. Default value is 5.
